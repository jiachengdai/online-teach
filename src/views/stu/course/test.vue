  ...
  <div class="mainBody">
    <div class="testContainer">
      <div style="width: 1150px; height: 45px">
        <h2 style="margin-left: 20px; font-family: '阿里妈妈数黑体'">课堂测验</h2>
      </div>
...
.testCard {
  ...
  width: 96%;
  height: 60px;
  background: linear-gradient(90deg, #e8f0ff 0%, #f7fafd 100%);
  margin-top: 10px;
  display: flex;
  box-shadow: 0 2px 8px 0 rgba(88, 114, 173, 0.08);
  border: 1.5px solid #e0e7ef;
  transition: background 0.2s, box-shadow 0.2s, border 0.2s;
  font-family: '阿里妈妈数黑体', 'Microsoft YaHei', Arial, sans-serif;
  font-size: 16px;
  letter-spacing: 0.5px;
}
.testCard:hover {
  background: linear-gradient(90deg, #d2e6ff 0%, #e6f7ff 100%);
  box-shadow: 0 4px 16px 0 rgba(88, 114, 173, 0.13);
  border: 1.5px solid #5891ff;
}
.testCardRight {
  display: flex;
...
.testCardRight > div > div:first-child {
  font-size: 18px;
  font-weight: bold;
  color: #234;
  margin-bottom: 2px;
...
.testCardRight > div > div:last-child {
  font-size: 15px;
  color: #4b5a6b;
